...
public abstract class User {
    ...
    public void decreaseNumberOfBooksCheckedOut() {
        if(numberOfBooksCheckedOut == 0)
            throw new IllegalNumberOfCheckedOutItemsException("User "+ name +" exceeded the limit of books checked out: "+ getLimitOfBooksToCheckOut());
        numberOfBooksCheckedOut--;
    }
    ...
    public String toString() {
        ...
        sb.append(", numberOfBooksCheckedOut=").append(numberOfBooksCheckedOut);
